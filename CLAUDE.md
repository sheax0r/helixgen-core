...
- `tests/` — pytest suite (run with `PYTHONPATH=$PWD/src python -m pytest`); golden-output contract (`tests/golden/`) + 211-export real-device round-trip (`tests/test_decompile_acceptance.py`) pin `.hsp` fidelity
